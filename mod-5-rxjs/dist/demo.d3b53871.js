...
var observable$ = new _rxjs.Observable(function (sub) {
  ...
  sub.next(1);
  sub.next(2);
  sub.next(3); // sub.error(new Error("Oops"));
...
var jokesUrl = "http://api.icndb.com/jokes/random/10/?limitTo=[nerdy]&escape=javascript"; // mapNumbers.addEventListener("click", () => {
// const evenNumbers = numbers
//   .filter(n => n % 2 === 0)
//   .map(n => ({ n }));

(0, _rxjs.fromEvent)(mapNumbers, "click").pipe((0, _operators.switchMap)(function () {
  return (0, _rxjs.from)(numbers).pipe((0, _operators.filter)(function (n) {
    return n % 2 === 0;
  }), (0, _operators.map)(function (n) {
    return {
      n: n
    };
  }), (0, _operators.scan)(function (p, c) {
    return [].concat(_toConsumableArray(p), [c]);
  }, []));
...
(0, _rxjs.fromEvent)(startTimer, "click").pipe((0, _operators.switchMap)(function () {
  return (0, _rxjs.interval)(1000).pipe((0, _operators.filter)(function (n) {
    return n % 2 === 0;
  }), (0, _operators.map)(function (n) {
    return {
      n: n
